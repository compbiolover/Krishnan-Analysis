...
```{r echo=FALSE}
by_cohort_age_type_12wk <- mecp2_data_processed_12wk %>% group_by(Cohort, Time,
                                                            Cell_type,
                                                            Condition,
                                                            Hemisphere)
```
...
overall_test_label <- create_test_label(description = "Kruskal-Wallis",
                                        ...
                                        statistic = 0.0029, p = "0.9565",
                                        parameter = "1", n = 188, detailed = TRUE,
                                        type = "expression")
...
total_plot <- ggplot(aes(x=Combo,y=Intensity, fill=Cohort), data = mecp2_6_12_pos)+
  ...
  xlab("")+
  ggtitle("PV Nuclei")+
  geom_signif(y_position = c(5200, 5100), xmin = c(1.0,3.0), xmax = c(2.0,4.0),
              annotations = c("ns", "ns"), tip_length = 0)+
  geom_signif(y_position = 5700, xmin = 1.0, xmax = 3.0, annotations = "ns",
              tip_length = 0)+
  geom_signif(y_position = 5400, xmin = 2.0, xmax = 4.0, annotations = "ns",
              tip_length = 0)+
  labs(
...
overall_test_label <- create_test_label(description = "Kruskal-Wallis",
                                        statistic.text = quote(italic(chi)^2),
                                        statistic = 17.34698, p = "3.114e-05",
                                        parameter = "1", n = 223,
...
total_plot <- ggplot(aes(x=Combo,y=Intensity, fill=Cohort), data = mecp2_6_12_neg)+
  ...
  geom_signif(y_position = c(2600, 2100), xmin = c(1.0,3.0), xmax = c(2.0,4.0),
              annotations = c("****", "ns"), tip_length = 0)+
  geom_signif(y_position = 2800, xmin = 1.0, xmax = 3.0, annotations = "ns",
              tip_length = 0)+
  geom_signif(y_position = 3000, xmin = 2.0, xmax = 4.0, annotations = "****",
              tip_length = 0)+
  labs(
    subtitle = overall_test_label,
    caption = get_pwc_label(example_of_pwc)
...
lme_mod <- lme(Intensity~Time, data=mecp2_6_12_neg , random = ~ 1|Cohort,
               method = "ML")
...
lme_mod_6wk_comp <- lme(Intensity~Condition, data=six_wk_comp_df, 
...
lme_mod_12wk_comp <- lme(Intensity~Condition, data=twelve_week_comp,
                         random = ~ 1|Cohort, method = "ML")
...
lme_mod_wt_v_wt_comp <- lme(Intensity~Time, data=wt_v_wt_comp, random = ~ 1|Cohort,
                            method = "ML")
...
lme_mod_het_v_het_comp <- lme(Intensity~Time, data=het_v_het_comp, random = ~ 1|Cohort, 
                              method = "ML")
...
total_plot <- ggplot(aes(x=Combo, y=Intensity, fill=Cohort),
  ...
  geom_signif(y_position = 2800, xmin = 1.0, xmax = 3.0, annotations = "ns",
              tip_length = 0)+
  geom_signif(y_position = 3000, xmin = 2.0, xmax = 4.0, annotations = "ns",
              tip_length = 0)+
...
#This is the overall model
lme_mod <- lme(Intensity~Time, data=mecp2_6_12_pos, random = ~ 1|Cohort,
               method = "ML")
...
lme_mod_het_v_het_comp <- lme(Intensity~Time, data=het_v_het_comp,
                              random = ~ 1|Cohort, 
                              method = "ML")
...
total_plot <- ggplot(aes(x=Combo, y=Intensity, fill=Cohort),
  ...
  geom_signif(y_position = c(5100, 5100), xmin = c(1.0,3.0), xmax = c(2.0,4.0),
              annotations = c("ns", "ns"), tip_length = 0)+
  geom_signif(y_position = 5400, xmin = 1.0, xmax = 3.0, annotations = "ns",
              tip_length = 0)+
  geom_signif(y_position = 5700, xmin = 2.0, xmax = 4.0, annotations = "ns",
              tip_length = 0)+
  labs(subtitle = overall_test_label,
       caption = get_pwc_label(example_of_pwc))
...
overall_label <-  create_test_label(description = "Mann Whitney U",
...
fig_9 <- fig_9 + scale_fill_manual(values = c("102319"="blue", 
                                              "103119"="purple", 
                                              "121119A"="green",
                                              "121119B"="magenta"))
